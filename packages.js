/**
 * Componente: paquetes.js (Artistaa Emergente - Navigator Style)
 * Características: Galería superior, logo enmarcado, texto con branding "aa".
 * Botones: Estilo cápsula Navigator (Cristal + Neón).
 * Iconos: Azules -> Rosa en Hover.
 */
...
const SnaapPaquetesComponent = (() => {
    const styles = `
        ...
        :root {
            ...
            --glass-card: rgba(10, 10, 15, 0.8);
        }

        .snaap-paquetes-section {
            width: 100%;
        ...
        .paquete-header h2 span {
            color: var(--snaap-azul-claro);
            text-shadow: 0 0 15px var(--snaap-azul);
        }
        ...
        .galeria-nav {
            ...
            box-shadow: 0 0 10px var(--snaap-azul);
        }

        .galeria-nav:hover {
            border-color: var(--snaap-rosa);
            color: var(--snaap-rosa);
            box-shadow: 0 0 20px var(--snaap-rosa);
            transform: scale(1.1);
        }
        ...
        .paquete-logo-frame {
            ...
            height: 200px;
            background: #000;
            border: 4px solid var(--snaap-azul-claro);
            border-radius: 25px;
            display: flex;
            align-items: center;
            justify-content: center;
            box-shadow: 0 0 25px var(--snaap-azul), inset 0 0 15px var(--snaap-azul);
            position: relative;
        }

        .paquete-logo-frame img {
            width: 80%;
        ...
        .paquete-info h3 span {
            color: var(--snaap-azul-claro);
            text-shadow: 0 0 12px var(--snaap-azul);
        }
        ...
        /* --- BOTONES ESTILO NAVEGADOR (PETICIÓN BOBIS) --- */
        .paquete-acciones {
            display: flex;
            flex-direction: column;
            gap: 20px;
        ...
        /* HOVER: TODO A ROSA EXPLOSIVO */
        .btn-snaap-pkg:hover {
            border-color: var(--snaap-rosa);
            color: var(--snaap-rosa);
            box-shadow: 0 0 25px rgba(255, 0, 122, 0.5), inset 0 0 5px rgba(255, 0, 122, 0.2);
            transform: translateY(-5px) scale(1.03);
        }

        .btn-snaap-pkg:hover i {
            color: var(--snaap-rosa);
        }
