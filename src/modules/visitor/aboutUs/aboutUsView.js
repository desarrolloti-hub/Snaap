// src/modules/visitor/aboutUs/aboutUsView.js
...
<div class="snaap-acerca-section">
    <div class="snaap-acerca-cabecera">
        ...
        <button class="btn-cotizar-navigator btn-cotizar-flotante" id="btnCotizarFlotante">
            Cotizar
        </button>
    </div>
        ...
        <div class="acerca-bloque">
            ...
            <div class="bloque-imagen-carrusel">
                <div class="acerca-slide-wrapper" id="carrusel-1">
                    ...
                    <img class="acerca-slide" src="https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?q=80&w=600&auto=format&fit=crop" alt="Evento 2">
                    <img class="acerca-slide" src="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=600&auto=format&fit=crop" alt="Evento 3">
                    <img class="acerca-slide" src="https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=600&auto=format&fit=crop" alt="Evento 4">
                </div>
